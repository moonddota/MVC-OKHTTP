...
public class MAVLinkPacket implements Serializable {
    ...
    */
    ...
    public MAVLinkPacket(int payloadLength) {
        protocol = Protocol.PROTOCOL_2_0;
        incompat_flags = 0;
        compat_flags = 0;
        len = payloadLength;
    ...
    public MAVLinkMessage unpack() {
        switch (msgid) {
            ...
            case msg_vip_events.MAVLINK_MSG_ID_VIP_EVENTS:
                return new msg_vip_events(this);
                 
            case msg_prearm_flag.MAVLINK_MSG_ID_PREARM_FLAG:
                return new msg_prearm_flag(this);
                 
            case msg_user_status.MAVLINK_MSG_ID_USER_STATUS:
                return new msg_user_status(this);
                 
            case msg_event_ack.MAVLINK_MSG_ID_EVENT_ACK:
                return new msg_event_ack(this);
