...
public class MAV_DATA_STREAM {
   ...
   public static final int MAV_DATA_STREAM_PARAMS = 13; /* Dependent on the autopilot | */
   public static final int MAV_DATA_STREAM_ADSB = 14; /* Dependent on the autopilot | */
   public static final int MAV_DATA_STREAM_PREARM_ERROR_FLAG = 15; /* Dependent on the autopilot | */
   public static final int MAV_DATA_STREAM_USER_STATUS = 16; /* Dependent on the autopilot | */
   public static final int MAV_DATA_STREAM_USER_LOCATION = 17; /* Dependent on the autopilot | */
