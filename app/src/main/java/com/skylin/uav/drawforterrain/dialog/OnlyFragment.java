 ...
 * 只有一个按钮的对话框
 */
public class OnlyFragment extends BaseDialogFragment {
    /**
     * 消息标题
     */
    ...
    private TextView tvTitle, tvMsg, tvBtnContent;
    ...
    protected void initView(View view) {
        tvTitle = (TextView) view.findViewById(R.id.only_title);
        tvMsg = (TextView) view.findViewById(R.id.only_message);
        tvBtnContent = (TextView) view.findViewById(R.id.only_confirm);
    }

    @Override
    protected int getLayoutResId() {
        return R.layout.only_operation;
    }
