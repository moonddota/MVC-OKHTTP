...
//        if (!contain)ic_return false;
        ...
        boolean b1 = (point.getLongitude() - start.getLongitude()) * (point.getLongitude() - end.getLongitude()) <= 0
                || TQMath.equals(point.getLongitude(), start.getLongitude())
                || TQMath.equals(point.getLongitude(), end.getLongitude());
        boolean b2 = (point.getLatitude() - start.getLatitude()) * (point.getLatitude() - end.getLatitude()) <= 0
                || TQMath.equals(point.getLatitude(), start.getLatitude())
                || TQMath.equals(point.getLatitude(), end.getLatitude());
        return b1 && b2;
    }
